...
export const coursesDataStatic: TPayloadCoursesDataStatic = {
  ...
  'CS-6211': {
    ...
    departmentId: 'CS',
    courseNumber: '6211',
    url: 'https://omscs.gatech.edu/cs-6211-system-design-cloud-computing',
    aliases: ['SICC', 'SDCC'],
    isDeprecated: false,
    isFoundational: true,
  },
  ...
  'CS-6261': {
    ...
    departmentId: 'CS',
    courseNumber: '6261',
    url: 'https://omscs.gatech.edu/cs-6261-security-incident-response',
    aliases: ['SIR'],
    isDeprecated: false,
    isFoundational: false,
  },
  ...
  'CS-6263': {
    ...
    departmentId: 'CS',
    courseNumber: '6263',
    url: 'https://omscs.gatech.edu/cs-6263-intro-cyber-physical-systems-security',
    aliases: ['CPSS'],
    isDeprecated: false,
    isFoundational: true,
  },
  ...
  'CS-6435': {
    ...
    departmentId: 'CS',
    courseNumber: '6435',
    url: 'https://omscs.gatech.edu/cs-6435-digital-health-equity',
    aliases: ['DHE'],
    isDeprecated: false,
    isFoundational: true,
  },
  ...
  'CS-6491': {
    ...
    departmentId: 'CS',
    courseNumber: '6491',
    url: 'https://omscs.gatech.edu/cs-6491-foundations-computer-graphics',
    aliases: ['FCG', 'CG'],
    isDeprecated: false,
    isFoundational: true,
  },
  ...
  'CS-7400': {
    ...
    departmentId: 'CS',
    courseNumber: '7400',
    url: 'https://omscs.gatech.edu/cs-7400-quantum-computing',
    aliases: ['QC'],
    isDeprecated: false,
    isFoundational: true,
  },
  ...
  'CS-8803-O15': {
    ...
    url: 'https://omscs.gatech.edu/cs-8803-o15-introduction-computer-law',
    aliases: ['ICL', 'CL', 'Law'],
    isDeprecated: false,
    isFoundational: false,
  },
  ...
  'CS-8803-O23': {
    ...
    departmentId: 'CS',
    courseNumber: '8803-O23',
    url: 'https://omscs.gatech.edu/cs-8803-o23-modern-internet-research-methods',
    aliases: ['MIRM'],
    isDeprecated: false,
    isFoundational: false,
  },
  ...
  'CS-7496': {
    ...
    departmentId: 'CS',
    courseNumber: '7496',
    url: 'https://omscs.gatech.edu/cs-7496-computer-animation',
    aliases: [],
    isDeprecated: false,
    isFoundational: true,
  },
  'CS-8803-O20': {
    courseId: 'CS-8803-O20',
    name: 'Quantum Hardware',
    departmentId: 'CS',
    courseNumber: '8803-O20',
    url: 'https://omscs.gatech.edu/cs-8803-o20-quantum-hardware',
    aliases: [],
    isDeprecated: false,
    isFoundational: false,
  },
  'CS-8803-O27': {
    courseId: 'CS-8803-O27',
    name: 'Computer Graphics in the AI Era',
    departmentId: 'CS',
    courseNumber: '8803-O27',
    url: 'https://omscs.gatech.edu/cs-8803-o27-computer-graphics-ai-era',
    aliases: [],
    isDeprecated: false,
    isFoundational: false,
  },
  'CS-8803-O29': {
    courseId: 'CS-8803-O29',
    name: 'Health Sensing and Interventions',
    departmentId: 'CS',
    courseNumber: '8803-O29',
    url: 'https://omscs.gatech.edu/cs-8803-o29-health-sensing-and-interventions',
    aliases: [],
    isDeprecated: false,
    isFoundational: false,
  },
  'ISYE-6525': {
    ...
    departmentId: 'ISYE',
    courseNumber: '6525',
    url: 'https://omscs.gatech.edu/isye-6525-topics-high-dimensional-data-analytics',
    aliases: [],
    isDeprecated: false,
    isFoundational: false,
  },
